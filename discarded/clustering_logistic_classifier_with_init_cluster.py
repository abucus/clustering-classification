...
class ClusteringLogisticClassifierWithInitCluster(ClusteringLogisticClassifier):
    '''
    classdocs
    '''


    def __init__(self, numOfClusters, outputPath, numOfInitCluster):
        '''
        labelList is a argument not in use here
        '''
        ClusteringLogisticClassifier.__init__(self, numOfClusters, outputPath)
    ...
    def fit(self, x, y):
        ...
        for i in range(maxIterateNum):
            for j in range(numOfClusters):
                ...
                out.outputFig(data, clusters, initClusters, i, models=classifiers, optionalTitle="beforeVote")
                out.saveData(clusters, "iter_"+str(i)+"_clusters_beforeVote")
                # Step 2.4 reset label for each init cluster
                ...
                out.outputFig(data, clusters, initClusters, i, models=classifiers, optionalTitle="afterVote")
